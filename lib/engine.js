...
export function initTracker(opts) {
  ...
  try { var saved = JSON.parse(localStorage.getItem(STORAGE) || "{}"); ["mode", "tab", "year"].forEach(function (k) { if (saved[k] != null) state[k] = saved[k]; }); if (saved.heatMetric) state.heatMetric = saved.heatMetric; } catch (e) {}
