...
export function initTracker(opts) {
  ...
  function ensureEntry() {
    ...
    state.entry = { id: null, dataset: ds, branch: (session && session.branch) || "", period: m.periods[m.lastActive].iso, entryDate: todayISO(), items: [], row: blankRow(), values: {}, audit: "", msg: "", msgOk: false };
  }
  ...
  function readEntryForm() {
    ...
    if ((v = g("entry-date")) != null && v !== "") e.entryDate = v;
  ...
  function renderEntry() {
    ...
    var header = '<div class="card" style="margin-bottom:12px">' +
      ...
      '<div style="flex:1;min-width:0"><div class="period-select-label" style="margin-bottom:5px">Date of entry</div>' + dateSel + "</div></div>";
    var body;
    if (e.dataset === "opstd") {
  ...
  var LOGIN_MARK = '<img src="/pulsus-quality.png" alt="Pulsus Quality" style="height:56px;width:auto;display:block;flex-shrink:0">';
  ...
  async function handleAction(a, el) {
    ...
    if (a === "entry-save" || a === "entry-submit") {
      ...
      var body = { action: a === "entry-submit" ? "submit" : "save", id: e.id || undefined, dataset: e.dataset, branch: e.branch, period: e.period, entryDate: e.entryDate };
  ...
  function onChange(e) {
    ...
    else if (e.target.id === "entry-date") { readEntryForm(); }
