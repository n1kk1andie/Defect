...
export function initTracker(opts) {
  ...
  function renderReport() {
    ...
    document.getElementById("content").innerHTML =
      ...
      '<div class="card" style="margin-bottom:12px"><div class="row between mid" style="gap:10px">' +
        ...
        '<div class="row gap8 no-print" style="flex-shrink:0">' +
          '<button class="lockbtn" data-action="download-open" title="Download data (CSV, Excel, PDF)" aria-label="Download data">' +
            '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/></svg></button>' +
  ...
  async function handleAction(a) {
    ...
    if (a === "download-open") { showDownloadModal(); return; }
  ...
  function onClick(e) {
    ...
    if (t.hasAttribute("data-dlfmt")) { if (state.dl) state.dl.format = t.getAttribute("data-dlfmt"); showDownloadModal(); return; }
